...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/page_manager_manageNotice2.css"text/css">
...
<div class="content w clearfix">
    <div class="mainBody clearfix">
        ...
        <div class="postList clearfix">
            ...
            <div class="detailNotice clearfix">
                <div class="noticeTitle">
                    ${notice.noticeTitle}
                </div>
                <div class="cookie clearfix">
                    <div class="noticeTime">
                        发帖时间:<span>${notice.noticeTime}</span>
                    </div>
                </div>

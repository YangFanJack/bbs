...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/page_manager_manageNotice1.css"text/css">
...
<div class="content w clearfix">
    <div class="mainBody clearfix">
        ...
        <div class="postList clearfix">
            <span class="T">通知管理</span>
            <div class="notices clearfix">
                <c:forEach items="${noticePageBean.list}" var="keyword" varStatus="id">
                    <div class="notice clearfix">
                        <div class="noticeTitle">
                            <a href="oneNotice?id=${keyword.id}"><span>${keyword.noticeTitle}</span></a>
                        </div>
                        <div class="manButton">
                            <input onclick="window.location='deleteNotice?id=${keyword.id}'" type="button" class="deleteButton" value="删除">
                        </div>
                    </div>
                </c:forEach>

...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/page_manager_certifyPost1.css" type="text/css">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li>
                            ...
                            <a href="certifyPost1?currentPage=${postPageBean.currentPage-1}" aria-label="Previous">
                        ...
                        <c:forEach  var="i" begin="1" end="${postPageBean.totalPage}">
                            ...
                            <a href="certifyPost1?currentPage=${i}">${i}</a></li>
                        </c:forEach>
                        ...
                        <li>
                            ...
                            <a href="certifyPost1?currentPage=${postPageBean.currentPage+1}&totalPage=${postPageBean.totalPage}" aria-label="Next">
